...
app.get('/excel',function (req,res) {
  var i = 0;
  T.get('search/tweets', { q: 'tbc', since:'2018-04-12', until: '2018-04-19' ,count:100,geocode:'-2.3200252,99.4343617,1000km'}, function(err, data, response) {
  title = [[
      'No',
      'Tanggal',
      'Tweet',
    ...
    res.setHeader( "Content-Disposition", "filename=TBC.xlsx" );
    res.send(buffer);
  })
